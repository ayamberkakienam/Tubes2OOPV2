...
//        System.out.println(map_brs + " " + map_kol + " " + num_cage);
      ...
      for (i = 0; i < map_brs; i++) {
        ...
        while (j < str_temp[i].length()) {
          if (count < 9) {
            ...
            } else if ((map[i][j] == '#') || (map[i][j] == '~') || (map[i][j] == '*') || (map[i][j] == '.') || (map[i][j] == '+') || (map[i][j] == '=') || (map[i][j] == '$') || (map[i][j] == '!')) {
              j++;
              jneff++;
            } else { // angka satu digit beda
              if ((map[i][j + 1] == '#') || (map[i][j + 1] == '~') || (map[i][j + 1] == '*') || (map[i][j + 1] == '.') || (map[i][j + 1] == '+') || (map[i][j + 1] == '=') || (map[i][j + 1] == '$') || (map[i][j + 1] == '!')) {
                j = j + 2;
                jneff++;
              } else { //dua digit
                j = j + 3;
            ...
            if (map[i][j] == digit1) {
              if (map[i][j + 1] == digit2) {
                ...
                idx++;
                jneff++;
              } else if ((map[i][j + 1] == '#') || (map[i][j + 1] == '~') || (map[i][j + 1] == '*') || (map[i][j + 1] == '.') || (map[i][j + 1] == '+') || (map[i][j + 1] == '=') || (map[i][j + 1] == '$') || (map[i][j + 1] == '!')) {
                j = j + 2;
                jneff++;
              } else { //dua digit beda
                j = j + 3;
            ...
            } else if ((map[i][j] == '#') || (map[i][j] == '~') || (map[i][j] == '*') || (map[i][j] == '.') || (map[i][j] == '+') || (map[i][j] == '=') || (map[i][j] == '$') || (map[i][j] == '!')) { //bukan angka
              j++;
              jneff++;
  ...
  void TourZoo() {
    ...
    for (int i = 0; i < panjang; i++) {
      for (int j = 0; j < lebar; j++) {
        ...
        if (i == 0 || i == panjang - 1 || j == 0 || j == lebar - 1) {
          if (my_zoo.getCell()[i][j].getContent() == '=') {
            masuk_x[n_masuk] = i;
            masuk_y[n_masuk] = j;
            n_masuk++;
          }
    ...
    for (int i = 0; i < panjang; i++) {
      for (int j = 0; j < lebar; j++) {
        cont = my_zoo.getCell()[i][j].getContent();
        if (cont == '+' || cont == '!' || cont == '=') {
          maze_zoo[i][j] = 1;
        } else {
          maze_zoo[i][j] = 2;
        ...
        if (fup) {
          for (int a = 0; a < my_zoo.getCage()[k].getSize(); a++) {
            for (int b = 0; b < Animal.getNAnimal(); b++) {
              if (my_zoo.getCage()[k].getCell()[a].getX() == my_zoo.getAnimal()[b].getLocX() && my_zoo.getCage()[k].getCell()[a].getY() == my_zoo.getAnimal()[b].getLocY()) {
